---
title: "Prep 2: HTML & CSS"
categories: preps
due_date: 2026-09-17 10:00:00 -0400
order: 2
---

**Due:** Thursday, September 17th, 10am\
...
4. **Make a webpage.** Make a simple HTML file in your private repo with some static content. Using the style
   ...
   generate your page.** (We aren't looking for anything fancy---just that you
   spend some time engaging with these languages by hand.)

5. **Submit GitHub commit hash on [Commons](https://class.mit-sdg.dev/)**.
<!--
Try enabling the styles below in devtools!
You may have to click on the appropriate tag to see its possible styles.
-->
