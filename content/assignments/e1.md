...
- How does the class fit into your larger goals in life? To your career and intellectual journey?
...
- **Workarounds and comparables**. Describe the workarounds that people currently use to mitigate the bad situations. If solutions already exist for the problem you've identified, or for closely related problems, list them, and explain clearly why they don't mitigate the particular bad situations you plan to address. 
- **Solution sketch**. Sketch an idea for a solution. The reason for doing this is not to embark on detailed design, but to gain some confidence that a plausible solution might exist. (You don't literally need to include a visual sketch, but you're welcome to do so if it helps!).

Submit your assignment in Commons. See [guide on submitting git commit hashes](../guides/hash.md).

## Resources

Your work will be evaluated using the following rubrics:
- [Problem framing](../rubrics/problem-framing.md) (for the problem framing part, weight of 3)
- [Reflective practice](../rubrics/reflective-practice.md) (for the personal goals part, weight of 1)
- [Technical writing](../rubrics/technical-writing.md) (for both parts, weight of 1)
...
- [Setting up your repo](../guides/repo.md)
- [Markdown](../resources/technical.md#markdown)
- [Git and GitHub](../resources/technical.md#github)
...
**Bad situations aren't missing features**. The most common mistake that innovators make is to confuse a missing feature with a bad situation. A missing feature is just a pointer to some functionality that may turn out to solve a real problem, but may not, and anyway is an inflexible start for a design that leaves little room for creativity. Not being able to vacuum in the corner of the room because the cord won't stretch far enough is a bad situation. Wanting your vacuum cleaner to be battery-powered is identifying a missing feature. The pattern "I can't do X" is not a reliable way to spot bad situations. "I can't keep track of all my files, because they're on different computers and cloud drives and I can never find the one I want" is a genuine bad situation. But "I can't search for a file by name across Google Drive and Dropbox" is a feature request in disguise.

**An example**. Here's an example of what might go into a problem statement. Note that it's only an outline to give you a sense of what might be included; a full solution would be longer and more detailed. You'll have to go back in time to before 2001 (before you were born) to imagine a world in which this is a problem, and you probably won't be able to find one this compelling,  but it should give you some idea of what a good problem looks like:
