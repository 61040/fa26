---
title: "Assignment A2: Understanding Concepts"
categories: assignments
due_date: 2026-09-21 23:59:00 -0400
order: 2
---
...
Define a concept for the essential function of a URL shortening service such as [tinyurl.com](https://tinyurl.com) or [bit.ly](http://bit.ly). Your concept should support both user-defined and autogenerated URL suffixes.

### Event Inviting

Define a concept for the essential function of an inviting service like [Evite](https://www.evite.com) and [Paperless Post](https://www.paperlesspost.com). 
...
- **Formatting concepts in markdown**. For tips on how to do this, see [this resource](../resources.md#formatting-concepts-markdown).
...
- **Rubric**. You can use the concept design rubric as a checklist for your concepts: [see the rubric](../resources.md#concept-rubric).
- **State notation guide**. There is an overview of the state declaration notation [here](../resources.md#state-notation).
